...
def options():
    ...
    parser.add_argument('--input_cmp', default=0, type=float, help='Use gradient compression for input gradients.')
    ...
    parser.add_argument('--rec_cmp', default=0, type=float, help='Use gradient compression for reconstruction.')
    parser.add_argument('--mix', action='store_true', help='Use a mixed reconstruction method.')
